...
<body>
	...
	<div class="user-info-list-pannel">
		...
		<div class="top-header-pannel">
			...
			<div class="function-btn-pannel">
				<button onclick="javascript:location='list'">
					목록
				</button>
				...
				<table class="edu-table flexibleTable" tb="edu">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" data="eduStartdate" class="eduStartdate dateInput prevDate"></td>
							<td><input type="text" data="eduEnddate" class="eduEnddate dateInput laterDate"></td>
		...
		<div class="health-inventory-table-pannel">
			<table class="health-inventory-table flexibleTable" tb="health">
				  <thead>
				  	<tr>
						<td rowspan="2">혈액형</td>
						<td rowspan="2">신장</td>
				  ...
				  <tbody>
					<tr>
						<td><input type="text" data="userBloodtype" class="userBloodtype"></td>
						<td><input type="text" data="userHeight" class="userHeight" ></td>
						<td><input type="text" data="userEyesightLeft" class="userEyesightLeft" ></td>
						<td><input type="text" data="userEyesightRight" class="userEyesightRight" ></td>
						<td><input type="text" data="userWeight" class="userWeight" ></td>
						<td><input type="text" data="userHobby" class="userHobby" ></td>
						<td><input type="text" data="userSpeciality" class="userSpeciality"></td>
					</tr>
				  </tbody>
			  </table>
		 </div>
	...
	<div class="pop-user-register-pannel" id="drag-ele1">
		...
		<div class="pop-user-search-pannel">
			...
			<select id="userInfomarriage">
				<option value="" selected="selected">결혼유무</option>
				<option value="기혼">기혼</option>
				<option value="미혼">미혼</option> 
			</select>
			<input type="hidden" id="userMarriage" name="userMarriage">
