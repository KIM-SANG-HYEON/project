...
var ajaxRequestRegisterList = function(){
	...
	var prevLimit = parseInt((nowPage - 1) * dataSize +1);
	...
	var userMarriage = $("input[name='userMarriage']").val();
	if(userMarriage==undefined){
		console.log(userMarriage=="undefined");
		userMarriage=null;
	}
	
	var userListSearchPeriod = $("input[name='userListSearchPeriod']").val();
	if(userListSearchPeriod==undefined){
		console.log(userListSearchPeriod=="undefined");
		userListSearchPeriod=null;
	}
	
	var userListSearchWord = $("input[name='userListSearchWord']").val();
	if(userListSearchWord==undefined){
		console.log(userListSearchWord=="undefined");
		userListSearchWord=null;
	}
	
	var userCareerLength = $("input[name='userCareerLength']").val();
	if(userCareerLength==undefined){
		console.log(userCareerLength=="undefined");
	...
	var reqData = {
			"userListSearchPeriod" : userListSearchPeriod // 검색 조건
			, "userListSearchWord" : userListSearchWord // 검색어
			, "userCareerLength" : userCareerLength // 조회경력
			, "keywords" : keywords // 조회 키워드
			, "prevLimit" : prevLimit // 조회 시작 row
			, "dataSize" : dataSize 
			, "laterLimit" : laterLimit	// 조회 끝 row
